...
class SubscribersControllerTest < ActionController::TestCase
  ...
  test "should create subscriber" do
    assert_difference('Subscriber.count') do
      post :create, subscriber: { email: @subscriber.email, first_name: @subscriber.first_name, last_name: @subscriber.last_name }
    end
  ...
  test "should update subscriber" do
    patch :update, id: @subscriber, subscriber: { email: @subscriber.email, first_name: @subscriber.first_name, last_name: @subscriber.last_name }
    assert_redirected_to subscriber_path(assigns(:subscriber))
  end
